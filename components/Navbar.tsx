...
export default function Navbar() {
  ...
  const creativeCategories = [
    ...
    {
      label: "Handmade Occasion-Special Items",
      slug: "creativeAndHandcrafted/handmade-special",
    },
    { label: "Jutt Item", slug: "creativeAndHandcrafted/jutt-item" },
    {
      ...
      submenu: [
        {
          label: "Dry Flowers",
          slug: "creativeAndHandcrafted/coir-products/dry-flowers",
        },
      ],
    },
  ];
  ...
  const crystalsCategories = [
    {
      label: "Natural Crystals",
      slug: "crystalsAndSpiritual/natural-crystals",
    },
    ...
    {
      label: "Crystal Clocks",
      slug: "crystalsAndSpiritual/anklets/crystal-clocks",
    },
    {
      label: "Crystal Pyramid",
      slug: "crystalsAndSpiritual/anklets/crystal-pyramid",
    },
    {
      label: "Crystal Pencils",
      slug: "crystalsAndSpiritual/anklets/crystal-pencils",
    },
    { label: "Crystal Box", slug: "crystalsAndSpiritual/anklets/crystal-box" },
    {
      label: "Crystal Idols",
      slug: "crystalsAndSpiritual/anklets/crystal-idols",
    },
    {
      label: "Pyrite Dust Frames",
      slug: "crystalsAndSpiritual/anklets/pyrite-dust-frames",
    },
    {
    ...
    {
      label: "Crystal Strings",
      slug: "crystalsAndSpiritual/anklets/crystal-strings",
    },
    {
      label: "Crystal Animals",
      slug: "crystalsAndSpiritual/anklets/crystal-animals",
    },
    {
      label: "Anklets",
    ...
    { label: "Pooja Items", slug: "crystalsAndSpiritual/pooja-items" },
    {
      ...
      submenu: [
        { label: "God Idols", slug: "crystalsAndSpiritual/sage/god-idols" },
      ],
    },
  ];
                      ...
                      <div key={cat.slug}>
                        {cat.submenu ? (
                          <>
                            <button
                              onClick={() => {
                                if (cat.label === "Anklets")
                                  setMobileAnkletsOpen((p) => !p);
                                if (cat.label === "Sage")
                                  setMobileSageOpen((p) => !p);
                              }}
                              className="w-full flex items-center justify-between py-1 text-sm text-black"
                            >
                              <span>{cat.label}</span>
